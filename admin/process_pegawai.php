...
if (isset($_POST['create'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: pegawai.php?status=success&action=tambah");
    } else {
...
if (isset($_POST['update'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: pegawai.php?status=success&action=ubah");
    } else {
        // Redirect with error status
        header("Location: pegawai.php?status=error");
    }
...
if (isset($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: pegawai.php?status=success&action=hapus");
    } else {
