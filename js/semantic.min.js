        ...
        r.each(function (p) {
          ...
          (w = {
            ...
            setup: {
              ...
              menu: function (e) {
                U.php(O.menu(e, A)), (W = U.find(P.item));
              },
              reference: function () {
                w.debug(
            ...
            add: {
              ...
              message: function (t) {
                ...
                n.length > 0
                  ? n.php(i)
                  : (n = e("<div/>").php(i).addClass(T.message).appendTo(U));
              },
      ...
      return (
        r.each(function () {
          ...
          (y = {
            ...
            get: {
              html: function () {
                return R.removeData(T.php), R.data(T.php) || x.php;
              },
              title: function () {
            ...
            addResults: function (t) {
              return e.isFunction(g.onResultsAdd) &&
                ...
                ? (m.debug("onResultsAdd callback cancelled default action"),
                  !1)
                : (D.php(t), void (m.can.show() && m.showResults()));
            },
